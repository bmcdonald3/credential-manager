...
import (
	...
	_ "github.com/user/test/pkg/apiversion"
	...
	. "github.com/user/test/internal/middleware"
	

	
	"github.com/openchami/fabrica/pkg/reconcile"
	"github.com/user/test/pkg/reconcilers"
...
var rootCmd = &cobra.Command{
	Use:   "test",
	Short: "",
	Long:  `test - A Fabrica-generated OpenCHAMI service`,
	RunE:  runServer,
}

var serveCmd = &cobra.Command{
	Use:   "serve",
	Short: "Start the test server",
	Long:  `Start the test HTTP server with the configured options`,
	RunE:  runServer,
}
...
func runServer(cmd *cobra.Command, args []string) error {
	...
	if eventConfig.EventTypePrefix == "" {
		eventConfig.EventTypePrefix = "test.resource"
	}
...
func healthHandler(w http.ResponseWriter, r *http.Request) {
	...
	w.Write([]byte(`{"status":"healthy","service":"test"}`))
}
...
var versionCmd = &cobra.Command{
	...
	Long:  `Print the version number of test`,
	Run: func(cmd *cobra.Command, args []string) {
		fmt.Println("test v1.0.0")
	},
}
