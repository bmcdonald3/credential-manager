...
func runServer(cmd *cobra.Command, args []string) error {
	...
	if config.ReconcileEnabled {
		...
		// Register BmcCredential reconciler with injected secret store.
		bmcCredentialReconciler := reconcilers.NewBmcCredentialReconciler(storageClient, eventBus, secretStore)
		if err := controller.RegisterReconciler(bmcCredentialReconciler); err != nil {
