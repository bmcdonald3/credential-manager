...
curl -sS -X POST -H 'Content-Type: application/json' -d '{"metadata":{"name":"rotate-bmc-172"},"spec":{"targetAddress":"172.24.0.3","targetAccount":"3","secretId":"bmc-secret-172","rotationTrigger":"test-run-1"}}' http://localhost:8090/bmccredentials/
